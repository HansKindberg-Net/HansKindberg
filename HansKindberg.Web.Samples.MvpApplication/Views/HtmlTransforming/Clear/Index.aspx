<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Layout.master" AutoEventWireup="false" CodeBehind="Index.aspx.cs" Inherits="HansKindberg.Web.Samples.MvpApplication.Views.HtmlTransforming.Clear.Index"
%><asp:Content ContentPlaceHolderID="TitleContent" runat="server">Clear html-transforming</asp:Content>
<asp:Content ContentPlaceHolderID="HeadingContent" runat="server">Clear html-transforming</asp:Content>
