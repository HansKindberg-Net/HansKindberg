...
namespace HansKindberg.DirectoryServices
{
	public class DirectorySearcherOptions : IDirectorySearcherOptions
	{
		...
		public virtual LazyInitialization<string> AttributeScopeQuery { get; set; }
		...
		public virtual LazyInitialization<DirectorySynchronization> DirectorySynchronization { get; set; }
		public virtual ExtendedDN? ExtendedDistinguishedName { get; set; }
		public virtual LazyInitialization<string> Filter { get; set; }
		public virtual int? PageSize { get; set; }
		public virtual LazyInitialization<IEnumerable<string>> PropertiesToLoad { get; set; }
		...
		public virtual LazyInitialization<SortOption> Sort { get; set; }
		public virtual bool? Tombstone { get; set; }
		public virtual LazyInitialization<DirectoryVirtualListView> VirtualListView { get; set; }
